...
<body>
    <header class="lg:h-52 bg-sky-800 text-neutral-50 p-4 items-center content-center border-b border-gray-50">
        <h1 class="xl:text-4xl lg:text-3xl md:text-2xl text-center text-sm border-b border-sky-100 pb-5 mx-auto">Selamat
            Datang di <br />
    ...
    <main class="lg:w-3/4 border border-sky-100 rounded-sm shadow-md m-auto mt-5 p-4 bg-sky-50">
        ...
        <form action="{{ route('register') }}" method="POST" enctype="multipart/form-data"
            ...
            <div>
                <label for="profile_picture" class="block text-sm font-medium text-gray-700 mb-1">Foto Profil <span
                        class="text-xs text-neutral-400">(Opsional)</span> </label>
            ...
            <div class="col-span-2 w-2xl mx-auto">
                <div>
                    <button type="submit"
