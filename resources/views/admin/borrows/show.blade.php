        ...
        <div class="title p-4 flex flex-row items-center justify-between">
            ...
            <div class="flex flex-row gap-2">
                ...
                <div class="flex items-center w-fit">
                    <a href="{{ route('borrows.index') }}" class="text-teal-950 font-bold">
                        <i data-lucide="chevron-left" class="w-10 h-10 inline"></i>
                    </a>
                </div>

                <div class="">
                    <h3 class="text-xl text-neutral-700 font-bold">Detail Peminjaman</h3>
                    <p class="text-xs text-neutral-500">Menu ini menampilkan detail peminjaman.</p>
                </div>
            </div>
        </div>
