...
@section('content')
    <div class="content flex flex-col flex-auto bg-gray-50 w-full" x-data="{ openAddinformationModal: false }" x-cloak>
        ...
        {{-- Alert Gagal --}}
        <div x-data="{ show: {{ session('error') ? 'true' : 'false' }} }" x-show="show" x-init="setTimeout(() => show = false, 6000)" x-transition x-cloak>
        ...
        {{-- Alert Berhasil --}}
        <div x-data="{ show: {{ session('success') ? 'true' : 'false' }} }" x-show="show" x-init="setTimeout(() => show = false, 6000)" x-transition x-cloak>
