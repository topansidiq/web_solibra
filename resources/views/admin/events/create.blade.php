...
@section('content')
    <div class="content flex flex-col flex-auto bg-gray-50 w-full" x-data="{ openAddinformationModal: false }" x-cloak>
        ...
        <div x-data="{ show: {{ session('error') ? 'true' : 'false' }} }" x-show="show"
            x-init="setTimeout(() => show = false, 6000)" x-transition x-cloak>
        ...
        <div class="title p-4 flex flex-row items-center justify-between">
            <h3 class="text-xl text-neutral-700 font-bold">Tambah Acara</h3>
        ...
        <form action="{{ route('events.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="grid grid-cols-2 gap-6">
                ...
                <div class="col-span-2 flex">
                    <div>
                        <label for="start_at" class="block font-medium text-sm mb-1">Mulai</label>
                        <input type="date" name="start_at" id="start_at"
                            class="w-full p-2 border border-neutral-300 rounded-md focus:outline-none focus:ring focus:ring-sky-300"
                            required>
                    </div>
                    <div>
                        <label for="end_at" class="block font-medium text-sm mb-1">Berakhir</label>
                ...
                <div class="col-span-2">
                    ...
                    <div id="quillEditor" class="bg-white border border-neutral-300 rounded-md" style="height: 150px;">
                    </div>
                ...
                {{-- Gambar --}}
                <div class="col-span-2">
                    <label for="location" class="block font-medium text-sm mb-1">Lokasi</label>
                ...
                {{-- Gambar --}}
                <div class="col-span-2">
                    <label for="poster" class="block font-medium text-sm mb-1">Poster</label>
