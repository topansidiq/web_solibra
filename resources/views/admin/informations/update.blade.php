    ...
    <div class="w-full">
        ...
        <div class="flex flex-row gap-2 p-4">
            ...
            <div>
                ...
                <p class="text-xs text-neutral-500">Halaman ini digunakan untuk memperbarui data informasi</p>
            </div>
        </div>

        {{-- Form Edit Informasi --}}
        <div class="mx-4 mb-4 p-4 rounded-sm bg-neutral-50">
            <form action="{{ route('informations.update', $information->id) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="grid grid-cols-2 gap-6">
                    ...
                    <div class="col-span-2">
                        ...
                        @if ($information->images)
                            <div class="mt-2">
                                <img src="{{ asset('storage/' . $information->images) }}" alt="Current Image"
                ...
                <div class="flex justify-end gap-2 pt-4">
                    <a href="{{ route('informations.index') }}"
                        class="text-xs px-6 py-2 bg-red-500 hover:bg-red-600 text-white font-semibold rounded transition">
                        Batal
                    </a>
                    <button type="submit"
                        class="text-xs px-6 py-2 bg-sky-800 hover:bg-sky-900 text-white font-semibold rounded transition">
                        Simpan Perubahan
                    </button>
                </div>
            </form>
