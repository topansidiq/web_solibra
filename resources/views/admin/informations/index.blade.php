...
@section('content')
    <div class="content flex flex-col flex-auto bg-gray-50 w-full" x-data="{ openAddinformationModal: false }" x-cloak>
        ...
        <div class="title p-4 flex flex-row items-center justify-between">
            ...
            <div>
                <h3 class="text-xl font-bold">Daftar Informasi</h3>
                <p class="text-sm">Ini adalah daftar informasi atau postingan di perpustakaan</p>
            </div>
            <div>
                <a href="{{ route('informations.create') }}"
                    class="flex flex-row items-center justify-around rounded-md cursor-pointer px-2 py-1 bg-sky-800 text-neutral-200 gap-2">
                    <i data-lucide="plus" class="block w-4 h-4"></i>
                    <p class="text-xs">Tambah Informasi</p>
                </a>
            </div>
        </div>
