<div class="sticky top-0 left-0 flex flex-col bg-sky-950 w-80 h-screen" x-data="{ active: '{{ Route::currentRouteName() }}', transaction: false }">
    ...
    <div class="flex items-center space-x-3 p-4">
        ...
        <div class="logo leading-tight">
            <p class="text-xs text-neutral-400">Akses Utama</p>
    ...
    <div class="flex items-center space-x-3 p-4">
        <div class="logo leading-tight">
            <p class="text-neutral-50 text-xs font-bold">Master: {{ Auth::user()->id }}</p>
    ...
    @php
        $menu = [
            ['label' => 'Beranda', 'name' => 'master.dashboard', 'icon' => 'home'],
            ['label' => 'Admin', 'name' => 'master.admins', 'icon' => 'shield-user'],
            // ['label' => 'Koleksi', 'name' => 'master.books', 'icon' => 'book-open'],
            // [
            //     'label' => 'Transaksi',
            //     'icon' => 'list',
            //     'item' => [
            //         ['label' => 'Peminjaman', 'name' => 'master.borrows', 'icon' => 'list'],
            //         ['label' => 'Pengembalian', 'name' => 'master.return', 'icon' => 'repeat'],
            //         ['label' => 'Arsip', 'name' => 'master.archived', 'icon' => 'archive'],
            //     ],
            // ],
            // ['label' => 'Pengguna', 'name' => 'master.users', 'icon' => 'user'],
            // ['label' => 'Notifikasi', 'name' => 'master.notification', 'icon' => 'bell'],
            // ['label' => 'Laporan', 'name' => 'master.reports', 'icon' => 'download'],
        ];
    @endphp
